...
import HeroSection from "../components/LandPageComponents/HeroSection";
import FeedSection from '../components/LandPageComponents/FeedSection';
import BlogSection from "../components/LandPageComponents/BlogSection";
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full ">
        <div className="w-full">
          <div className="flex-row px-20 flex w-full pt-20">
            <div className="flex-col flex w-2/3 text-left break-words">
              <div className="text-lime-600 pb-3 font-medium ">WHY CHOOSE REALESTATE</div>
              <div className="text-[1.8rem] font-bold">Provides the most complete list of property</div>
            </div>
            <div className="w-1/3 text-justify text-neutral-700 px-6">Find the ideal property that is most suitable for you. Starting from houses for sale that are minimalist, apartments for sale that are exclusive.</div>
          </div>
          <div className="py-[68px] w-full px-20">
            <div className="w-full grid-cols-3 grid gap-10">
              <div className="hover:shadow-md rounded-[9px] text-justify px-10 py-10">
                <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name='Isolation Mode' viewBox="0 0 24 24" width='54' height='54' fill="#65a30d" className="block m-auto">
                ...
                <div className="font-bold text-[1.1rem] text-center py-3">Find your dream house</div>
                <div className="text-neutral-800 text-[15px]">Many ads for apartments and houses for sale in various locations. Tap your finger on the screen then open the door of your dream house from here.</div>
              </div>
              <div className="hover:shadow-md rounded-[9px] text-justify px-10 py-10">
                <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name='Isolation Mode' viewBox="0 0 24 24" width='54' height='54' fill="#65a30d" className="block m-auto">
                ...
                <div className="font-bold text-[1.1rem] text-center py-3">Find place of business</div>
                <div className="text-neutral-800 text-[15px]">Renting a place of business and buying and selling shop houses becomes easier. Meet your business and investment needs faster.</div>
              </div>
              <div className="hover:shadow-md rounded-[9px] text-justify px-10 py-10">
                <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name='Isolation Mode' viewBox="0 0 24 24" width='54' height='54' fill="#65a30d" className="block m-auto">
                ...
                <div className="font-bold text-[1.1rem] text-center py-3">Smart feature rich</div>
                <div className="text-neutral-800 text-[15px]">There are 900 thousand property ads. Everything you can explore and plan using smart features like the Mortgage Calculator.</div>
              </div>
            </div>
          </div>
          <FeedSection/>
