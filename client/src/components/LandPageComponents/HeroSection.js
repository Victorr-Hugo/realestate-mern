    ...
    return(
        <div className="w-full relative">
            <div className="absolute  top-1/2 left-1/2 -translate-x-1/2">
                <div>
                    <div className="text-white text-[32px] font-medium">Discover a place you will love to live</div>
                </div>
                <div className="flex-col flex h-full">
                    <div onClick={() => navigate('/properties')} className="cursor-pointer ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-300 flex-row relative flex rounded-[9px] bg-white w-[960px] py-1">
                        <div className="w-full grid grid-cols-4 m-auto">
                            <div className="flex-row flex w-full px-5">
                                <div className="my-auto px-4">
                                    <div className="bg-[#65a30d]/20 rounded-full p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name='Isolation Mode' viewBox="0 0 24 24" width='24' height='24' fill="#65a30d" className="m-auto h-full block">
                            ...
                            <div className="flex-row flex w-full px-5">
                                ...
                                <div className="flex-col flex text-left">
                                    ...
                                    <div className="text-[12px] text-neutral-700">price range</div>
                                </div>
                            </div>
                            <div className="flex-row flex w-full px-5">
                                <div className="my-auto px-4">
                        ...
                        <div className="h-full px-2 p-1">
                            <div className="bg-lime-600 rounded-[9px] p-2">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Isolation_Mode" data-name='Isolation Mode' viewBox="0 0 24 24" width='24' height='24' fill="white" className="m-auto h-full block">
            ...
            <img alt="" src={banner} className='h-[432px] w-full object-cover'/>            
        </div>
    );
}
